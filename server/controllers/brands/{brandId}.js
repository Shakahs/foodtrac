...
module.exports = {
  ...
  get(req, res) {
    ...
    const eagerOption = req.query.eager
      ? '[trucks.locations, food_genres, menu_items, brand_comments(newestFirst).users.brand_reviews, brand_reviews(newestFirst).users, upvotes, events_attending.events]'
      : '';
