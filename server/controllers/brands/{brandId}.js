...
module.exports = {
  ...
  get(req, res) {
    ...
    const eagerOption = req.query.eager
      ? '[trucks.locations, food_genres, menu_items, brand_comments(newestFirst).users.[brand_reviews, brands], brand_reviews(newestFirst).users, upvotes, events_attending.events, coupon, cover_image, logo_image]'
      : '';
