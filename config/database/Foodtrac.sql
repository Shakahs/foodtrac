...
-- -----------------------------------------------------
-- Table `foodtrac`.`FoodTypes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `foodtrac`.`FoodTypes` ;

CREATE TABLE IF NOT EXISTS `foodtrac`.`FoodTypes` (
...
CREATE TABLE IF NOT EXISTS `foodtrac`.`MenuItems` (
  ...
  INDEX `Menu_FoodType_idx` (`food_type_id` ASC),
  CONSTRAINT `Menu_Brand`
    FOREIGN KEY (`brand_id`)
    REFERENCES `foodtrac`.`Brands` (`id`),
  CONSTRAINT `Menu_FoodType`
    FOREIGN KEY (`food_type_id`)
    REFERENCES `foodtrac`.`FoodTypes` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT);
...
CREATE TABLE IF NOT EXISTS `foodtrac`.`BrandComments` (
  ...
  INDEX `BrandComment_Users` (`users_id` ASC),
